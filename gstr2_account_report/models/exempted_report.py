...
class GSTR2L10nInExemptedReport(models.Model):
    _name = "gstr2.l10n_in.exempted.report"
    ...
    def _select(self):
        select_str = """SELECT aml.id AS id,
            ...
            am.date,
            aml.balance * (CASE WHEN aj.type = 'purchase' THEN -1 ELSE 1 END) AS price_total,
            am.journal_id,
            aj.company_id,
