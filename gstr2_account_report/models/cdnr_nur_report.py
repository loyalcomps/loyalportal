...
class GSTR2L10nInAccountInvoiceReport(models.Model):
    _name = "gstr2.l10n_in.account.invoice.report"
        ...
        sub_select_str = """
            SELECT aml.id AS id,
                ...
                CASE WHEN tag_rep_ln.account_tax_report_line_id IN
                    ...
                    END AS price_total,
                (CASE WHEN aj.type = 'purchase' AND (am.type IS NULL OR am.type != 'in_refund') THEN -1 ELSE 1 END) AS amount_sign,
